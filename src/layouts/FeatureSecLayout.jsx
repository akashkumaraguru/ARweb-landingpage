...
const FeatureSecLayout = (props) =>{
    return(
      <div className='relative mt-5 w-fit overflow-hidden border rounded-xl border-neutral-800 min-h[800px]'>
     

        <div className=' ml-20 mt-10 lg:mt-20 '>    
            <div className='w-full sm:1/2 lg:w-2/3'>
              <div className='flex '>
                      ...
                      <h5 className='mt-1 mb-6 text-xl '>{props.text}</h5>
                          ...
                          <p className='text-md p-2 mb-6 ml-20 text-neutral-500'>{props.description}</p>
              </div>
            </div>
